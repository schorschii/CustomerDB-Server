...
const LANG = [
	...
	'invalid_token' => 'Недействительная или уже использованная ссылка (можно использовать только один раз)',
	...
	'authentication_failed' => 'Ошибка аутентификации. Пожалуйста, сначала создайте учетную запись в базе данных клиентов. Если у вас уже есть учетная запись, пожалуйста, проверьте имя пользователя и пароль для ошибок ввода.',
